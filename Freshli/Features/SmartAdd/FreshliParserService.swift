...
final class FreshliParserService {
    ...
    static let suggestionDatabase: [FoodSuggestion] = [
        ...
        FoodSuggestion(name: "Rice", icon: "wheat.bundle.fill", category: .grains, storage: .pantry, expiryDays: 365, unit: .kilograms),
        FoodSuggestion(name: "Pasta", icon: "wheat.bundle.fill", category: .grains, storage: .pantry, expiryDays: 365, unit: .grams),
        FoodSuggestion(name: "Oats", icon: "wheat.bundle.fill", category: .grains, storage: .pantry, expiryDays: 180, unit: .grams),
