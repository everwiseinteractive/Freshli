...
final class DepletionService {
    ...
    func recordConsumption(item: FreshliItem, modelContext: ModelContext) {
    ...
    func predictDepletion(for item: FreshliItem, modelContext: ModelContext) -> DepletionPrediction {
        let today = Date()
    ...
    func predictionsForAllItems(items: [FreshliItem], modelContext: ModelContext) -> [DepletionPrediction] {
