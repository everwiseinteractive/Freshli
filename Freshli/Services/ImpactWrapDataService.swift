...
final class ImpactWrapDataService {
    ...
    private func calculateMoneySaved(_ items: [FreshliItem]) -> Double {
        var total: Double = 0
    ...
    private func calculateCO2Avoided(_ items: [FreshliItem]) -> Double {
        var total: Double = 0
    ...
    private func calculateCategoryBreakdown(_ items: [FreshliItem]) -> [(category: FoodCategory, count: Int)] {
    ...
    private func calculateBestDayOfWeek(_ items: [FreshliItem]) -> String {
    ...
    private func calculateStreak(_ allItems: [FreshliItem]) -> (count: Int, label: String) {
        let calendar = Calendar.current
    ...
    private func calculateWeekOverWeekComparison(
        currentWeek: [FreshliItem],
        allItems: [FreshliItem],
        weekStart: Date
