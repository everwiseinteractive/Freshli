...
final class FoodIdentificationService {
    ...
    /// Convert identified results to PantryItem objects.
    /// - Parameters:
    ///   - result: The FoodIdentificationResult to convert
    ///   - quantity: Optional quantity override
    /// - Returns: PantryItem ready to add to inventory
    func convertToPantryItem(_ result: FoodIdentificationResult, quantity: Double = 1) -> PantryItem {
